...
Bot desenvolvido em Python que monitora cobranças e envia alertas automáticos via Telegram.
...
Credenciais protegidas via variáveis de ambiente (.env) — nunca expostas no repositório.
